...
import { Search, Calendar, Users, ChevronRight, ChevronLeft } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col space-y-6">
          <PageHeader
            ...
            description={
              selectedConference
                ? "View and search registered attendees."
                : "Select a conference to manage its participant list."
            }
            actions={
              selectedConference ? (
                <BackLink
