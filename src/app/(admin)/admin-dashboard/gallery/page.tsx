      ...
      <div className='bg-gray-200 px-5 py-5 mb-5 flex items-center justify-between'>
        ...
        <Dialog.Root open={isModalOpen} onOpenChange={setIsModalOpen}>
          <Dialog.Trigger asChild>
            <Button>
              <PlusIcon className="mr-2" /> Create Gallery
            </Button>
          </Dialog.Trigger>
          <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-[50%] top-[50%] z-50 w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] rounded-lg bg-white p-6 shadow-lg focus:outline-none">
              <Dialog.Title className="text-xl font-bold mb-4">Create New Gallery</Dialog.Title>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
          {galleries.map((gallery) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="text-xl font-semibold text-center">{gallery.year}</h3>
              </div>
            </div>
          ))}
        </div>
