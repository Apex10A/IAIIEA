...
const EventSpeakers = () => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      ...
      try {
        const response = await fetch(`${API_URL}/admin/user_list/speaker`, {
          method: 'GET',
          headers: {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div className="bg-white px-10 py-10 rounded-lg w-[30%]">
          <h2 className="text-xl font-bold mb-4">Edit Speakers</h2>
  ...
  return (
    ...
    <div className='flex items-center justify-between mb-4'>
      <div>
        <h1 className='text-[24px] md:text-[28px] text-[#0B142F] font-[500] pb-1'>Registered Event Speakers</h1>
      </div>
