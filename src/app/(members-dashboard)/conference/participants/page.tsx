...
const ConferenceParticipantsPage = () => {
  ...
  // Sort conferences by status (upcoming first) and then by date
  ...
  useEffect(() => {
    const fetchConferences = async () => {
      ...
      try {
        ...
        // Automatically select the first upcoming conference if available
        const upcoming = data.data.find((c: Conference) => c.status === "Upcoming");
        if (upcoming) {
          setSelectedConference(upcoming);
        }
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col space-y-6">
          ...
          {!selectedConference ? (
            ...
            /* Participants Section - Show when a conference is selected */
            <div className="space-y-6">
