...
const ConferenceAnnouncementsPage: React.FC = () => {
  ...
  const fetchAnnouncements = async () => {
    setIsLoading(true);
    try {
      const response = await fetch(`${API_URL}/announcements/conference`, {
        headers: {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <h3 className="text-lg font-medium text-gray-900">No Conference Registration</h3>
      <p className="text-gray-500 mt-1">
        You need to register for a conference to view announcements.
      </p>
    </div>
  );
