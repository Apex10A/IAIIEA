        ...
        <div className="flex flex-col space-y-6">
          ...
          {!selectedSeminar ? (
            ...
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-gray-800">Available Seminars</h2>
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-yellow-700">
                            You need to register for this seminar to view all participant details.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-500">
                      Please register for this seminar to view the participant list.
                    </p>
                  </CardContent>
                </Card>
              )}
